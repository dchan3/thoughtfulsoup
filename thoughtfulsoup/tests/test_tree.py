...
"""
    ...
    def test_id_child_selector_not(self):
        self.assertSelects('#inner > h2:not(h2:last-of-type)', ['header2'])

    def test_id_child_selector_is(self):
        self.assertSelects('#inner > h2:is(h2:last-of-type)', ['header3'])
